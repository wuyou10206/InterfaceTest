...
<script type="text/javascript">
	$(function(){
		$("#code_img").click(function(){
			this.src="/InterfaceTest/check_code?"+Math.random();
		});
	});
	$(function() {
		if ($("#login_error").val() != "") {
			alert($("#login_error").val());
			$("#login_error").val("");
		}
	});
</script>
		...
		<div id="login_content">
			<div class="loginForm">
				<form action="login" method="post">
					...
					<p>
						<label>验证码：</label> <input class="code" name="check_code" type="text" size="5" /> 
						<span><img id="code_img" src="/InterfaceTest/check_code" alt="" width="75" height="24" />
						</span>
					</p>
					<div class="login_bar">
				...
				%>
				<input type="hidden" value="<%=error == null ? "" : error%>"
					id="login_error" />
			</div>
