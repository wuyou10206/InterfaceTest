...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="add_module.jsp" target="dialog" rel="add_module"><span>添加</span></a></li>
			<li><a class="delete" href="delete_module?module_id={sid_user}" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<%
			...
			List<Module> modules= moduleService.findModule();
