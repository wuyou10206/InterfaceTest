...
public class SaveInterfaceServlet extends HttpServlet {
	private static final long serialVersionUID = -5703371219121899886L;
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int interfaceId = interfaceService.addInterface(interfaceName, interfaceAddress, requestMode,httpCode, moduleId, createUser, createDate, isDelete);
