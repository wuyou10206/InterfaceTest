...
public class InterfaceDownServlet extends HttpServlet {

	private static final long serialVersionUID = -6857885321978631833L;
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			json = AlertJson.successJson("向下移动成功","show_task_"+taskId,"show_task_"+taskId);
